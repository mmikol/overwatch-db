...
hero can appear in several, so the link table is many-to-many.
    ...
    python -m data.pipeline.load.wiki.meta --dsn postgresql://...
"""
...
from data.pipeline.extract.wiki.meta import COMPOSITION_PAGE, parse_playstyles
...
def main():
    ...
    with psycopg.connect(dsn) as connection:
        ...
        orchestrator.export_raw(connection, args, ("playstyles", "hero_playstyles"))
