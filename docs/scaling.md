...
| region — `hero_counters`, `hero_best_maps` | yes | Americas | widen `REGIONS`; ×4 requests |
...
| any — `hero_synergies` | deliberately none | authored | our judgement has no population; it is undimensioned by design |
