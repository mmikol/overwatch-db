...
| **META** | `competitive_tiers` · `hero_meta_stats` · `hero_playstyles` · `map_meta_stats` · `meta_snapshots` · `playstyles` · `regions` |
...
*foundation · 2 rows · `001_initial_schema.sql`*
